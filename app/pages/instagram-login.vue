<template>
  <div class="min-h-screen bg-black flex flex-col items-center pt-20 px-8 relative overflow-hidden">
    <div class="mb-12 text-white">
      <svg aria-label="Instagram" class="w-[175px] h-auto" fill="currentColor" role="img" viewBox="32 4 113 32">
    ...
    <div class="w-full max-w-[350px] flex flex-col items-center z-10">
      ...
      <div class="w-full mb-3">
        <input
          ...
          :value="username"
          readonly
          class="w-full h-[48px] bg-[#121212] border border-[#363636] rounded-[3px] px-4 text-white text-sm placeholder-[#9A9AA6] focus:outline-none focus:border-[#555]"
        />
      </div>
      ...
      <div class="w-full mb-4">
        <div class="relative">
          <input
            ...
            readonly
            class="w-full h-[48px] bg-[#121212] border border-[#363636] rounded-[3px] px-4 text-white text-sm placeholder-[#9A9AA6] focus:outline-none focus:border-[#555] tracking-widest"
          />
        </div>
      ...
      <div class="w-full bg-[#262626] border border-[#363636] rounded-[8px] p-3 mb-5 flex items-center gap-3">
        <div class="w-8 h-8 rounded-full bg-transparent border border-white/20 flex items-center justify-center flex-shrink-0 relative overflow-hidden">
            ...
            />
            <div v-else class="w-full h-full bg-[#0095F6] flex items-center justify-center">
      ...
      <!-- Forgot Password -->
      <a href="#" class="text-[#0095F6] text-[12px] font-medium mb-8">
        Esqueceu a senha?
      </a>

      <!-- Divider -->
      <div class="flex items-center gap-4 w-full mb-8 px-2">
        <div class="flex-1 h-[1px] bg-[#363636]"></div>
      ...
      <button class="flex items-center justify-center gap-2 text-[#0095F6] font-bold text-sm">
        <UIcon name="i-lucide-facebook" class="w-5 h-5 fill-current" />
    ...
    <div class="fixed bottom-0 left-0 w-full border-t border-[#363636] bg-black py-4 flex justify-center z-20">
      <p class="text-[#A8A8A8] text-[12px]">
        Não tem uma conta? <a href="#" class="text-[#0095F6] font-semibold ml-1">Cadastre-se.</a>
      </p>
    </div>
  </div>
</template>
